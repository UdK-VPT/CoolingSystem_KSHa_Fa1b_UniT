...
model CoolingSystemWithLoadCurves_Potsdam_normal
  ...
  weaDat(redeclare block WeatherData = BuildingSystems.Climate.WeatherDataDWD.Germany_Potsdam_normal_DWD_ASCII));
  annotation(
    __Dymola_Commands(file="modelica://CoolingSystems/Resources/Scripts/Dymola/Examples/CoolingSystemWithLoadCurves_Potsdam_normal.mos" "Simulate and plot"));
