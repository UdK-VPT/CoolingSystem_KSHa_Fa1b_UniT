...
model CoolingSystemWithBuildingModel
  ...
  Modelica.Blocks.Sources.Constant TAirSetCooling(
    k=273.15 + 26.0)
  ...
  BuildingSystems.Technologies.Chillers.CompressionChiller chi(
    ...
    dp1_nominal=1,
    dp2_nominal=1,
    redeclare BuildingSystems.Technologies.Chillers.Data.CompressionChillers.StandardChiller3000W chillerData)
...
equation
  ...
  annotation(experiment(StopTime=31536000),
    __Dymola_Commands(file="modelica://CoolingSystems/Resources/Scripts/Dymola/Examples/CoolingSystemWithBuildingModel.mos" "Simulate and plot"),
